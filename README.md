...
![](Aspose.Words.07a70c2c-4fc0-4793-ae9a-816569bac9ac.001.png)![](Aspose.Words.07a70c2c-4fc0-4793-ae9a-816569bac9ac.002.png)![](Aspose.Words.07a70c2c-4fc0-4793-ae9a-816569bac9ac.002.png)![](Aspose.Words.07a70c2c-4fc0-4793-ae9a-816569bac9ac.003.png)
...
The goal is to train end to end models for pose estimation on Pix3D dataset.

The pose estimation task is defined as a classification task. The model should classify the pose into 8 bins.
...
In general we have made 2 models, combined\_net and seperate\_net.

- Combined\_net, In this model a single convolution network consumes all the set of inputs (RGB, mask, boundaries, and normal) with 8 channels. 
...
- Separate\_net, In this model each RGB, mask, boundaries, and normal fead to a separate convolution layers and after some layers, The feature maps are concatenated together. 
